...
var author$project$Main$Model = F2(
	function (val, errorMessage) {
		return {errorMessage: errorMessage, val: val};
	});
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A2(author$project$Main$Model, 0, ''),
...
var author$project$Main$myget = F2(
	function (myurl, decoder) {
...
var author$project$Main$getValueHttp = function (topic) {
	return A2(
		elm$http$Http$send,
		author$project$Main$NewJson,
		A2(author$project$Main$myget, 'http://127.0.0.1:5000/return1', author$project$Main$valueDecoder));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Python':
				return _Utils_Tuple2(
					model,
					author$project$Main$getValueHttp('test'));
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					var newvar = result.a;
...
var author$project$Main$Python = {$: 'Python'};
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				elm$core$Debug$toString(model.val)),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$Python)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('SEND HTTP REQUEST')
					])),
				A2(
				elm$html$Html$b,
				_List_Nil,
